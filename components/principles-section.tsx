  ...
  const principles = [
    {
      ...
      description: "Every project starts with understanding your goals. We align design and development with business objectives.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Obsessive attention to detail across every touchpoint. From pixels to code, quality is non-negotiable.",
      align: "right",
    },
    {
      number: "03",
      ...
      description: "Brand strategy to final deployment. One team, one vision, seamless execution from concept to launch.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        ...
        { text: "PARTNERSHIPS", highlight: true },
      ],
      description: "We build relationships, not just projects. Ongoing support and collaboration that grows with you.",
      align: "right",
    },
  ]
